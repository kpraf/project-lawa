                        ...
                        const getCellColor = (classKey, value) => {
                          ...
                          if (sameValueCount > 1) {
                            ...
                            if (classesWithValue.includes('C')) {
                              return 'bg-green-500 font-bold text-white'; // Green for C and any classes sharing C's value
                            }
                ...
                <div className="mt-3 text-sm text-gray-600 font-sans space-y-1">
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full bg-white border border-gray-300 font-sans text-sm mb-2">
                      ...
                      <tbody>
                        <tr>
                          <td className="border px-3 py-2 font-sans font-bold bg-green-200">AA (Public Water Supply I)</td>
                        ...
                        <tr>
                          <td className="border px-3 py-2 font-sans font-bold bg-green-200">A (Public Water Supply II)</td>
                        ...
                        <tr>
                          <td className="border px-3 py-2 font-sans font-bold bg-green-100">B (Recreational Water I)</td>
                        ...
                        <tr>
                          <td className="border px-3 py-2 font-sans font-bold bg-black text-white">Failed</td>
